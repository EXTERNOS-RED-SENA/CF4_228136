    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-7
        ...
        ul.lista-ul--color
          li.d-flex
            i.fas.fa-check
            p.mb-0 Para #[b variables categóricas:] los mapas de calor de frecuencias, gráficos de mosaico y diagramas de barras apiladas visualizan patrones de concurrencia y asociación.
